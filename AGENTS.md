...
```
URL: ***REMOVED-URL***?token=***REMOVED-OLD-TOKEN***
```
...
```bash
# Check quota usage
ssh ***REMOVED-VPS*** "sudo docker exec <container-name> openclaw models status" | grep "google-antigravity usage"
...
# Check quota usage
ssh ***REMOVED-VPS*** "sudo docker exec <container-name> openclaw models status" | grep "usage:"
...
```bash
# List all profiles
ssh ***REMOVED-VPS*** "sudo docker exec <container-name> openclaw models auth list"

# Remove specific account
ssh ***REMOVED-VPS*** "sudo docker exec <container-name> openclaw models auth remove google-antigravity:account@gmail.com"
...
- If refresh fails, re-authenticate:
  ```bash
  ssh ***REMOVED-VPS*** "sudo docker exec <container-name> openclaw models auth login --provider google-antigravity"
  ```
