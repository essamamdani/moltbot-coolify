...
**Container:** `***REMOVED-DEPLOYMENT-ID***-072726042274`  
**Version:** 2026.2.2-3  
...
**Verify:**
```bash
ssh ***REMOVED-VPS*** "docker exec ***REMOVED-DEPLOYMENT-ID***-072726042274 openclaw cron list"
```
...
- **Name:** ***REMOVED-DEPLOYMENT-ID***-072726042274
...
- Dashboard: ***REMOVED-URL***?token=***REMOVED-OLD-TOKEN***
...
```bash
# Check status
ssh ***REMOVED-VPS*** "docker exec ***REMOVED-DEPLOYMENT-ID***-072726042274 openclaw status"

# List skills
ssh ***REMOVED-VPS*** "docker exec ***REMOVED-DEPLOYMENT-ID***-072726042274 openclaw skills list"

# View logs
ssh ***REMOVED-VPS*** "docker logs -f ***REMOVED-DEPLOYMENT-ID***-072726042274"

# Security audit
ssh ***REMOVED-VPS*** "docker exec ***REMOVED-DEPLOYMENT-ID***-072726042274 openclaw security audit --deep"
```
