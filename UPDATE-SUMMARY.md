...
**Container:** `openclaw-qsw0sgsgwcog4wg88g448sgs-071143757322`  
...
**Manual Fix (Run Now):**
```bash
ssh netcup "docker exec openclaw-qsw0sgsgwcog4wg88g448sgs-071143757322 bash /app/scripts/fix-skills-location.sh"
```
...
**Verify:**
```bash
ssh netcup "docker exec openclaw-qsw0sgsgwcog4wg88g448sgs-071143757322 openclaw skills list"
```
...
**Verify:**
```bash
ssh netcup "docker exec openclaw-qsw0sgsgwcog4wg88g448sgs-071143757322 openclaw cron list"
```
...
1. **Check logs:**
   ```bash
   ssh netcup "docker logs --tail 100 openclaw-qsw0sgsgwcog4wg88g448sgs-071143757322"
   ```

2. **Check status:**
   ```bash
   ssh netcup "docker exec openclaw-qsw0sgsgwcog4wg88g448sgs-071143757322 openclaw status --deep"
   ```
